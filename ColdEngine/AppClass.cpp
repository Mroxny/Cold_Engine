...
AppClass::AppClass(const std::string& commandLine):

	commandLine(commandLine),
	wnd(1280, 720, L"Cold Engine")//,
...
void AppClass::HandleInput(float dt)
{
...
void AppClass::DoFrame(float dt)
{
...
void AppClass::ShowImguiDemoWindow()
{
	/*if (showDemoWindow)
	{
